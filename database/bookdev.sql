...
CREATE
INDEX `fk_products_categories1_idx` ON `bookdev`.`products` (`categories_id` ASC) ;
...
CREATE
UNIQUE INDEX `email_UNIQUE` ON `bookdev`.`users` (`email` ASC) ;

CREATE
UNIQUE INDEX `username_UNIQUE` ON `bookdev`.`users` (`firstname` ASC) ;
...
CREATE
UNIQUE INDEX `number_UNIQUE` ON `bookdev`.`orders` (`number` ASC) ;

CREATE
INDEX `fk_orders_users_idx` ON `bookdev`.`orders` (`users_id` ASC) ;
...
CREATE
INDEX `fk_products_has_orders_orders1_idx` ON `bookdev`.`order_lines` (`orders_id` ASC) ;

CREATE
INDEX `fk_products_has_orders_products1_idx` ON `bookdev`.`order_lines` (`products_id` ASC) ;
