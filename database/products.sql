...
INSERT INTO `products` (`id`, `title`, `description`, `price_ht`, `weight`, `vat`, `stock`, `categories_id`)
VALUES (1, 'PHP pour les noobies',
        'Devenez un vrai crack du PHP, en lisant ce livre conçut et écrit par des développeurs qui utilisent PHP au quotidien, vous deviendrez bientôt la star de l\'open space',	34,	150,	20,	34,	4),
...
(7,	'Les serveurs web',	'Apprenez le fonctionnement et la configuration d\'un serveur web de A à Z', 45, 240, 20,
        13, 1),
...
(9,	'VS CODE',	'L\'ide gratuite pour tous et très puissante', 24, 120, 20, 54, 3),
       ...
       (11, 'Android studio', 'Créer vos propres applications pour smartphone et tablettes android', 35, 230, 20, 21,
        3),
